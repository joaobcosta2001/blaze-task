...
const resources = {
    en: {
        translation: {
            ...
            contacts_phone:"Phone: +351 910 544 467",
            contacts_email:"Email: blazetaskpt@gmail.com",
            NAME: "NAME",
            EMAIL: "EMAIL",
            SUBJECT: "SUBJECT",
            MESSAGE: "MESSAGE",
    ...
    pt:{
        translation: {
            ...
            contacts_phone:"Telemóvel: +351 910 544 467",
            contacts_email:"Email: blazetaskpt@gmail.com",
            NAME: "NOME",
            EMAIL: "EMAIL",
            SUBJECT: "ASSUNTO",
            ...
            process_section_description_1:"Nesta fase inicial, nós estudamos a fundo as operações da sua empresa, efetuando consultas minuciosas e entrevistando colaboradores. O nosso objetivo é ganhar uma compreensão profunda do fluxos de trabalho da sua empresa, identificar pontos problemáticos e reconhecer oportunidades de automação.",
